...
data: data.c structures/list.o structures/dynarray.o mp3/readID3v2dot3.o metadata.o
	$(CC) $(CFLAGS) data.c structures/list.o structures/dynarray.o mp3/readID3v2dot3.o metadata.o -o data
